...
const data =  {
  ...
  'features': [
    ...
    },
    {
      'name': 'золото',
      'properties': {
        'name': 'месторождение Анисимов ключ',
        'title': 'золото',
        'category': 'minning',
        'icon': 'qq',
        'description':
    ...
    },
    {
      'name': 'медная-цинковая руда',
      'properties': {
        'name': 'Юбилейно-Снигирихинская шахта',
        'title': 'медная-цинковая руда',
        'category': 'minning',
        'icon': 'qq',
        'description':
    ...
    },
    {
      'name': 'медная руда',
      'properties': {
        'name': 'месторождение Хаджиконган',
        'title': 'медная руда',
        'category': 'minning',
        'icon': 'qq',
        'description':
...
class App extends React.Component {
  ...
  constructor(props){
    ...
    this.state = {rightInd: 0};

    this.setMap = this.setMap.bind(this);
    this.setLayerDelete = this.setLayerDelete.bind(this);
