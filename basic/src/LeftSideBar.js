...
class LeftSideBar extends React.Component{
  ...
  render() {
    ...
    if(this.props.is_map_ready){
      boxes = [
        <LeftCheckBox layers_id={this.props.layers_id} update_layers={this.props.update_layers} symbol="Инфраструктура"  map={this.props.map} onLayerDisable={this.props.onLayerDisable} category="info" displayRightBox={this.props.displayRightBox}/>,
        <LeftCheckBox layers_id={this.props.layers_id} update_layers={this.props.update_layers} symbol="Месторождение" map={this.props.map} onLayerDisable={this.props.onLayerDisable} category="minning" displayRightBox={this.props.displayRightBox}/>,
        <LeftCheckBox layers_id={this.props.layers_id} update_layers={this.props.update_layers} symbol="Производство"  map={this.props.map} onLayerDisable={this.props.onLayerDisable} category="production" displayRightBox={this.props.displayRightBox}/>,
